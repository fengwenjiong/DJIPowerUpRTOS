...
RTE_ALIGN_32BYTES (__attribute__((section (".RAM_DTCM"))) uint8_t RTE_DTCM[128 * 1024]) = {0};
RTE_ALIGN_32BYTES (__attribute__((section (".RAM_AXIM"))) uint8_t RTE_AXIM[512 * 1024]) = {0};
#endif
/*************************************************
*** RTE_KVDB的相关函数
*************************************************/
...
void RTE_Init(void)
{
	...
	RTE_MEM_Pool(MEM_DTCM,RTE_DTCM,128*1024);
	RTE_MEM_Pool(MEM_AXIM,RTE_AXIM,512*1024);
#endif
