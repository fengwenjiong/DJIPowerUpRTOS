...
const Board_Spi_HardWare_Config_t LCDSpiConfig = 
{
	...
	.BaudRatePrescaler = SPI_BAUDRATEPRESCALER_4,//240/4=60M
};
const Board_Spi_HardWare_Config_t WIFISpiConfig = 
{
	...
	.BaudRatePrescaler = SPI_BAUDRATEPRESCALER_4,//400/4=100M MAX Speex 24Mbps*8
};
...
void Board_Spi_Init(Board_Spi_Name_e spiname,void (*MSPInitCallback)(void),void (*MSPDeInitCallback)(void))
{
  ...
  SpiHandle[spiname].SpiHalHandle.Init.MasterKeepIOState = SPI_MASTER_KEEP_IO_STATE_ENABLE;
