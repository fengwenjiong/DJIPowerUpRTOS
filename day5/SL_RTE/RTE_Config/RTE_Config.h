...
#define RTE_USE_KVDB                  0
	//<o>KVDB最小擦除单位大小
	//<i>单位：K
	#define KVDB_ERASE_MIN_SIZE         (2 * 1024)              /* it is 128K for compatibility */
	//<q>掉电保护
	...
	#define KVDB_ADDR_OFFSET            64 * 1024 
	//<o>FLASH首地址
...
#endif
		//<e> LVGL内核高级GUI
		//<i> 使用针对修改过的LVGL作为RTE_GUI内核，支持各类GUI高级特性和效果。
		#define GUI_USE_LVGL              1
#endif
//</e>
